%% Plot fluxes obtained from the second set of simulations, selected simulations
...
% 'GRASP-main/io/figure/second_simulations_boxplots' Their filenames indicate the
...
enzymesFluxesDirs = {'../../ensemble_simulation/enzymes_second_simple_D010/backup_b_car_simulation_enzymes_second_model_simple_D010.mat';
    ...
    '../../ensemble_simulation/enzymes_second_detailed_D025/backup_b_car_simulation_enzymes_second_model_detailed_D025.mat'};                           % filenames of enzyme modification simulations

metabolitesFluxesDirs = {'../../ensemble_simulation/metabolites_second_simple_D010/backup_b_car_simulation_metabolites_second_model_simple_D010.mat';
    ...
    '../../ensemble_simulation/metabolites_second_detailed_D025/backup_b_car_simulation_metabolites_second_model_detailed_D025.mat'};                   % filenames of metabolite modification simulations
...
perturbationNames = {'-50%';'-30%';'+40%';'+100%';'-33%';'+33%';'-50%';'+50%';'-30%';'+40%';
    '-50%';'-30%';'+40%';'+100%';'-30%';'+40%';'-30%';'+40%';'-30%';'+40%'};                                                                            % x label of perturbations

enzymesPerturbations = 1:10;                                                                                                                            % enzyme perturbations to be included
...
colorPaletteReference = [0.8500 0.3250 0.0980;0.9290 0.6940 0.1250;0 0.4470 0.7410;0.4660 0.6740 0.1880];                                               % first color palette
% colorPalettePerturbations = [0.4940 0.1840 0.5560;0.4660 0.6740 0.1880;0.3010 0.7450 0.9330;0.6350 0.0780 0.1840];                                    % second color palette
...
boxplotFigure = figure();
boxplotFigure.Position = [500 200 300 200];
lineplot = plot([0.6;perturbationsN+0.4],[meanRatioBcarLyc;meanRatioBcarLyc],'-','LineWidth',1,'Color',colorPaletteReference(4,:));
hold on
...
hold off
saveas(boxplotFigure,fullfile('..','io','figures','second_simulations_boxplot','png',[modelType,'_',referenceConditionName,'_','ratio','_boxplot.png']))
saveas(boxplotFigure,fullfile('..','io','figures','second_simulations_boxplot','jpg',[modelType,'_',referenceConditionName,'_','ratio','_boxplot.jpg']))
saveas(boxplotFigure,fullfile('..','io','figures','second_simulations_boxplot','svg',[modelType,'_',referenceConditionName,'_','ratio','_boxplot.svg']))
saveas(boxplotFigure,fullfile('..','io','figures','second_simulations_boxplot','mat',[modelType,'_',referenceConditionName,'_','ratio','_boxplot.fig']))   
