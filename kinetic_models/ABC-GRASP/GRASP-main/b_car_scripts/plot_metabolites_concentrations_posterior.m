%% Plot metabolite concentration distributions, only posteriors
...
% only the posterior distributions
...
% 'GRASP-main/io/figures/metabolites_concentrations_posterior_boxplots', and their
...
format longE
digits(256)                     % to prevent errors in calculcations
...
for ix = 1:length(metabolitesFiltered)
    boxplotFigure = figure();
    boxplotFigure.Position = [500 200 300 250];
    boxplot(log10(metabolitesFiltered{ix,1}),'Symbol','k.', 'Colors','k','PlotStyle','traditional','MedianStyle','line', ...
        'Labels',metaboliteNames{ix,1}(1:end),'Widths',0.5,'Jitter',0.5,'OutlierSize',2,'Positions',(1:length(metaboliteNames{ix,1})));
    title({'Boxplot posterior metabolite concentrations',['\beta-car',referenceName{1,1},' ',conditionFullNames{ix,1}]})
    ...
    hold off
    saveas(boxplotFigure,fullfile('..','io','figures','metabolites_concentrations_posterior_boxplot','png',[referenceName{1,1},conditionNames{ix,1},'_',modelTypes{ix,1},'_boxplot.png']))
    saveas(boxplotFigure,fullfile('..','io','figures','metabolites_concentrations_posterior_boxplot','jpg',[referenceName{1,1},conditionNames{ix,1},'_',modelTypes{ix,1},'_boxplot.jpg']))
    saveas(boxplotFigure,fullfile('..','io','figures','metabolites_concentrations_posterior_boxplot','svg',[referenceName{1,1},conditionNames{ix,1},'_',modelTypes{ix,1},'_boxplot.svg']))
    saveas(boxplotFigure,fullfile('..','io','figures','metabolites_concentrations_posterior_boxplot','mat',[referenceName{1,1},conditionNames{ix,1},'_',modelTypes{ix,1},'_boxplot.fig']))
end
...
for jx = 1:length(adjustedNames)
    for ix = 1:length(metabolitesFiltered)
        boxplotFigure = figure();
        boxplotFigure.Position = [500 200 300 250];
        boxplot(log10(metabolitesFiltered{ix,1}.*metabolitesRelativeFiltered{ix,jx}),'Symbol','k.', 'Colors','k','PlotStyle','traditional','MedianStyle','line', ...
            'Labels',metaboliteNames{ix,1}(1:end),'Widths',0.5,'Jitter',0.5,'OutlierSize',2,'Positions',(1:length(metaboliteNames{ix,1})));
        title({'Boxplot posterior metabolite concentrations',['\beta-car',adjustedNames{jx,1},' ',conditionFullNames{ix,1}]})
        ylabel('Log_{10} concentrations [M]')
        xlabel('Metabolites')
        xticks((1:length(metaboliteNames{ix,1})))
        grid('on')
        ...
        set(gca,'TickLabelInterpreter','none')
        hold off
        saveas(boxplotFigure,fullfile('..','io','figures','metabolites_concentrations_posterior_boxplot','png',[adjustedNames{jx,1},conditionNames{ix,1},'_',modelTypes{ix,1},'_boxplot.png']))
        saveas(boxplotFigure,fullfile('..','io','figures','metabolites_concentrations_posterior_boxplot','jpg',[adjustedNames{jx,1},conditionNames{ix,1},'_',modelTypes{ix,1},'_boxplot.jpg']))
        saveas(boxplotFigure,fullfile('..','io','figures','metabolites_concentrations_posterior_boxplot','svg',[adjustedNames{jx,1},conditionNames{ix,1},'_',modelTypes{ix,1},'_boxplot.svg']))
        saveas(boxplotFigure,fullfile('..','io','figures','metabolites_concentrations_posterior_boxplot','mat',[adjustedNames{jx,1},conditionNames{ix,1},'_',modelTypes{ix,1},'_boxplot.fig']))
    end
end
