%% Plot fluxes obtained from the first set of simulations, all metabolite simulations
...
% metabolites. The location of the filefolder can be specified.
...
% 'GRASP-main/io/figure/simulations_metabolites_boxplots'. Their filenames 
...
simulatedFluxesDirs = {'../../ensemble_simulation/metabolites_simple_D010/backup_b_car_simulation_metabolites_model_simple_D010.mat';
...
perturbationNames = {'-50%';'-30%';'+40%';'+100%';'-30%';'+40%';'-30%';'+40%';'-30%';'+40%'};                                                       % x label of perturbations
...
%     end
    hold off
    saveas(boxplotFigure,fullfile('..','io','figures','simulations_metabolites_boxplot','png',[modelType,'_',referenceConditionName,'_',targetFluxes{ix,1},'_boxplot.png']))
    saveas(boxplotFigure,fullfile('..','io','figures','simulations_metabolites_boxplot','jpg',[modelType,'_',referenceConditionName,'_',targetFluxes{ix,1},'_boxplot.jpg']))
    saveas(boxplotFigure,fullfile('..','io','figures','simulations_metabolites_boxplot','svg',[modelType,'_',referenceConditionName,'_',targetFluxes{ix,1},'_boxplot.svg']))
    saveas(boxplotFigure,fullfile('..','io','figures','simulations_metabolites_boxplot','mat',[modelType,'_',referenceConditionName,'_',targetFluxes{ix,1},'_boxplot.fig']))
...
hold off
saveas(boxplotFigure,fullfile('..','io','figures','simulations_metabolites_boxplot','png',[modelType,'_',referenceConditionName,'_','ratio','_boxplot.png']))
saveas(boxplotFigure,fullfile('..','io','figures','simulations_metabolites_boxplot','jpg',[modelType,'_',referenceConditionName,'_','ratio','_boxplot.jpg']))
saveas(boxplotFigure,fullfile('..','io','figures','simulations_metabolites_boxplot','svg',[modelType,'_',referenceConditionName,'_','ratio','_boxplot.svg']))
saveas(boxplotFigure,fullfile('..','io','figures','simulations_metabolites_boxplot','mat',[modelType,'_',referenceConditionName,'_','ratio','_boxplot.fig']))   
