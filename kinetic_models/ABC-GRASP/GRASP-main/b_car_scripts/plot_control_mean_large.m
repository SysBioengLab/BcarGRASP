...
% Unlike 'plot_control_mean' the heatmaps are larger and contain the names
% of the enzymes, reactions, fluxes, and metabolites
...
fluxFigure.Position = [500 300 275 275];
...
set(gca,'units','points','position',[50,50,130,130])
set(gca,'TickDir','out')
set(gca,'LineWidth',1)
set(gca,'XTickLabelRotation',90)
xlabel('Fluxes')
ylabel('Fluxes')
title({'Flux control coefficients of',conditionFullName})
...
set(cb,'Position',[0.9,cbparameters(2),0.025,cbparameters(4)])
mg = mesh(mx,my,zeros([nx,ny]+1));
mg.FaceColor = 'none';
mg.EdgeColor = 'k';
hold off

outputFluxFig = fullfile('..','io','figures','control_mean_large','mat',[fileName,'_mcaFluxes.fig']);
savefig(fluxFigure,outputFluxFig)
outputFluxJpg = fullfile('..','io','figures','control_mean_large','jpg',[fileName,'_mcaFluxes.jpg']);
saveas(fluxFigure,outputFluxJpg)
outputFluxSvg = fullfile('..','io','figures','control_mean_large','svg',[fileName,'_mcaFluxes.svg']);
saveas(fluxFigure,outputFluxSvg)
outputFluxPng = fullfile('..','io','figures','control_mean_large','png',[fileName,'_mcaFluxes.png']);
...
metFigure.Position = [500 300 275 275];
...
ylabel('Metabolites')
xlabel('Fluxes')
title({'Concentration control coefficients of ',conditionFullName})
set(gca,'FontSize',7,'FontName','arial')
...
outputMetFig = fullfile('..','io','figures','control_mean_large','mat',[fileName,'_mcaMetabolites.fig']);
savefig(metFigure,outputMetFig)
outputMetJpg = fullfile('..','io','figures','control_mean_large','jpg',[fileName,'_mcaMetabolites.jpg']);
saveas(metFigure,outputMetJpg)
outputMetSvg = fullfile('..','io','figures','control_mean_large','svg',[fileName,'_mcaMetabolites.svg']);
saveas(metFigure,outputMetSvg)
outputMetPng = fullfile('..','io','figures','control_mean_large','png',[fileName,'_mcaMetabolites.png']);
...
efluxFigure.Position = [500 300 275 275];
...
ylabel('Fluxes')
xlabel('Enzymes')
title({'Flux response coefficients of ',conditionFullName})
set(gca,'FontSize',7,'FontName','arial')
caxis(cLimitsFluxes)
...
outputeFluxFig = fullfile('..','io','figures','control_mean_large','mat',[fileName,'_crFluxes.fig']);
savefig(efluxFigure,outputeFluxFig)
outputeFluxJpg = fullfile('..','io','figures','control_mean_large','jpg',[fileName,'_crFluxes.jpg']);
saveas(efluxFigure,outputeFluxJpg)
outputeFluxSvg = fullfile('..','io','figures','control_mean_large','svg',[fileName,'_crFluxes.svg']);
saveas(efluxFigure,outputeFluxSvg)
outputeFluxPng = fullfile('..','io','figures','control_mean_large','png',[fileName,'_crFluxes.png']);
...
emetFigure.Position = [500 300 275 275];
...
ylabel('Metabolites')
xlabel('Enzymes')
title({'Concentration response coefficients of ',conditionFullName})
set(gca,'FontSize',7,'FontName','arial')
caxis(cLimitsMetabolites)
...
outputeMetFig = fullfile('..','io','figures','control_mean_large','mat',[fileName,'_crMetabolites.fig']);
savefig(emetFigure,outputeMetFig)
outputeMetJpg = fullfile('..','io','figures','control_mean_large','jpg',[fileName,'_crMetabolites.jpg']);
saveas(emetFigure,outputeMetJpg)
outputeMetSvg = fullfile('..','io','figures','control_mean_large','svg',[fileName,'_crMetabolites.svg']);
saveas(emetFigure,outputeMetSvg)
outputeMetPng = fullfile('..','io','figures','control_mean_large','png',[fileName,'_crMetabolites.png']);
...
OutputeFluxXls = fullfile('..','io','figures','control_mean_large','xls','crFluxes.xlsx');
...
OutputeMetXls = fullfile('..','io','figures','control_mean_large','xls','crMetabolites.xlsx');
