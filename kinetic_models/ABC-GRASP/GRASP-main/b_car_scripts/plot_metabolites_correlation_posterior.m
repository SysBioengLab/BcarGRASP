%% Plot heatmaps of metabolite distribution correlations, posterior models
...
% the posterior ensembles.

% It requires as input a posterior ensemble model located in the folder
...
% 'GRASP-main/io/figures/metabolites_correlation_posterior', and their
...
outputFig = fullfile('..','io','figures','metabolites_correlation_posterior','mat',[fileName,'_metCorrelation.fig']);
savefig(corrFigure,outputFig)
outputJpg = fullfile('..','io','figures','metabolites_correlation_posterior','jpg',[fileName,'_metCorrelation.jpg']);
saveas(corrFigure,outputJpg)
outputSvg = fullfile('..','io','figures','metabolites_correlation_posterior','svg',[fileName,'_metCorrelation.svg']);
saveas(corrFigure,outputSvg)
outputPng = fullfile('..','io','figures','metabolites_correlation_posterior','png',[fileName,'_metCorrelation.png']);
...
OutputXls = fullfile('..','io','figures','metabolites_correlation_posterior','xls','metCorrelation.xlsx');
