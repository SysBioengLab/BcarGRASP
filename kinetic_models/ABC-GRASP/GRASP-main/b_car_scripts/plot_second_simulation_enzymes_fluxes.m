%% Plot fluxes obtained from the second set of simulations, all enzyme simulations
...
% enzymes. The location of the filefolder can be specified. It also
% requires the original set of enzyme simulations to plot the best
...
% 'GRASP-main/io/figure/second_simulations_enzymes_boxplots'. Their filenames 
...
baseSimulationDirs = {'../../ensemble_simulation/enzymes_simple_D010/backup_b_car_simulation_enzymes_model_simple_D010.mat';
    ...
    '../../ensemble_simulation/enzymes_detailed_D025/backup_b_car_simulation_enzymes_model_detailed_D025.mat'};                             % filenames of the first set of enzyme modification simulations

simulatedFluxesDirs = {'../../ensemble_simulation/enzymes_second_simple_D010/backup_b_car_simulation_enzymes_second_model_simple_D010.mat';
    '../../ensemble_simulation/enzymes_second_simple_D025/backup_b_car_simulation_enzymes_second_model_simple_D025.mat';
    '../../ensemble_simulation/enzymes_second_regulated_D010/backup_b_car_simulation_enzymes_second_model_regulated_D010.mat';
    '../../ensemble_simulation/enzymes_second_regulated_D025/backup_b_car_simulation_enzymes_second_model_regulated_D025.mat';
    '../../ensemble_simulation/enzymes_second_detailed_D010/backup_b_car_simulation_enzymes_second_model_detailed_D010.mat';
    '../../ensemble_simulation/enzymes_second_detailed_D025/backup_b_car_simulation_enzymes_second_model_detailed_D025.mat'};               % filenames of the second set fo enzyme modification simulations
...
perturbationNames = {'+67%';'-50%';'-30%';'+40%';'+100%';'-33%';'+33%';'-50%';'+50%';'-30%';'+40%';'-30%';'+40%';
...
baseN = 8;                                                                                                                                  % index of the previous best perturbations
...
%     end
    hold off
    saveas(boxplotFigure,fullfile('..','io','figures','second_simulations_enzymes_boxplot','png',[modelType,'_',referenceConditionName,'_',targetFluxes{ix,1},'_boxplot.png']))
    saveas(boxplotFigure,fullfile('..','io','figures','second_simulations_enzymes_boxplot','jpg',[modelType,'_',referenceConditionName,'_',targetFluxes{ix,1},'_boxplot.jpg']))
    saveas(boxplotFigure,fullfile('..','io','figures','second_simulations_enzymes_boxplot','svg',[modelType,'_',referenceConditionName,'_',targetFluxes{ix,1},'_boxplot.svg']))
    saveas(boxplotFigure,fullfile('..','io','figures','second_simulations_enzymes_boxplot','mat',[modelType,'_',referenceConditionName,'_',targetFluxes{ix,1},'_boxplot.fig']))
...
hold off
saveas(boxplotFigure,fullfile('..','io','figures','second_simulations_enzymes_boxplot','png',[modelType,'_',referenceConditionName,'_','ratio','_boxplot.png']))
saveas(boxplotFigure,fullfile('..','io','figures','second_simulations_enzymes_boxplot','jpg',[modelType,'_',referenceConditionName,'_','ratio','_boxplot.jpg']))
saveas(boxplotFigure,fullfile('..','io','figures','second_simulations_enzymes_boxplot','svg',[modelType,'_',referenceConditionName,'_','ratio','_boxplot.svg']))
saveas(boxplotFigure,fullfile('..','io','figures','second_simulations_enzymes_boxplot','mat',[modelType,'_',referenceConditionName,'_','ratio','_boxplot.fig']))   
