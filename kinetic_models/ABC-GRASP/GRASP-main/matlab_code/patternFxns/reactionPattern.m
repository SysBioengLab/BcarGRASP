...
for i = 1:size(KineticMatrix,1)
    ...
    for j = 1:size(KineticMatrix,2)
        ...
        if (isempty(strfind(KineticMatrix{i,j},'P'))~=1 || ...
            ...
            isempty(strfind(KineticMatrix{i,j},'T'))~=1 || ...
            isempty(strfind(KineticMatrix{i,j},'U'))~=1 || ...
            isempty(strfind(KineticMatrix{i,j},'V'))~=1 || ...
            isempty(strfind(KineticMatrix{i,j},'W'))~=1 || ...
            isempty(strfind(KineticMatrix{i,j},'X'))~=1)
        ...
        elseif (isempty(strfind(KineticMatrix{i,j},'A'))~=1 ||...
                ...
                isempty(strfind(KineticMatrix{i,j},'G'))~=1 ||...
                isempty(strfind(KineticMatrix{i,j},'H'))~=1 ||...
                isempty(strfind(KineticMatrix{i,j},'J'))~=1)
