%% Sample and select models using ABC rejection for low growth and regulated structures
...
modelID = 'b_car_rejection_model_regulated_D010';                       % Name of the ensemble model
