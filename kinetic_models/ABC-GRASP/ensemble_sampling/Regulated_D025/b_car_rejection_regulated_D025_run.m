%% Sample and select models using ABC rejection for high growth and regulated structures
...
modelID = 'b_car_rejection_model_regulated_D025';                       % Name of the ensemble model
