%% Simulation of detailed models generated at high growth rate when metabolite concentrations are perturbated and CrtYB is upregulated
...
ensembleDir = fullfile('..','..','GRASP-main','io','output','b_car_rejection_model_detailed_D025.mat');     % direction of the model ensemble
strucIdx = 1;                                                                                               % always only one structure
dataDir = fullfile('..','..','GRASP-main','io','input','b_car_metabolites_second_simulation.xlsx');         % direction of the input file with perturbances
conditionsN = 16;                                                                                           % number of conditions to be simulated
parallelSampling = true;                                                                                    % if parallel process wants to be used
coresN = 16;                                                                                                % number of cores for parallel process
backupDir = 'backup_b_car_simulation_metabolites_second_model_detailed_D025.mat';                           % direction and name of backup file
