%% Simulation of detailed models generated at high growth rate when enzyme abundances are perturbated
...
backupDir = 'backup_b_car_simulation_enzymes_model_detailed_D025.mat';                                      % direction and name of backup file
solver = 'NLOPT'; %FMINCON                                                                                  % solver type, either NLOPT or FMINCON

%% Perform Simulation

tInitial = tic;
simulateFluxes(ensembleDir,strucIdx,dataDir,conditionsN,parallelSampling,coresN,solver,backupDir)
toc(tInitial)
