%% Simulation of detailed models generated at high growth rate when enzyme abundances are perturbated and CrtYB is upregulated
...
dataDir = fullfile('..','..','GRASP-main','io','input','b_car_enzymes_second_simulation.xlsx');             % direction of the input file with perturbances
conditionsN = 28;                                                                                           % number of conditions to be simulated
parallelSampling = true;                                                                                    % if parallel process wants to be used
coresN = 16;                                                                                                % number of cores for parallel process
backupDir = 'backup_b_car_simulation_enzymes_second_model_detailed_D025.mat';                               % direction and name of backup file
