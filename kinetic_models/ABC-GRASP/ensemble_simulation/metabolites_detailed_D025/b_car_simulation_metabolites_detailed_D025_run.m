%% Simulation of detailed models generated at high growth rate when metabolite concentrations are perturbated
...
dataDir = fullfile('..','..','GRASP-main','io','input','b_car_metabolites_simulation.xlsx');                % direction of the input file with perturbances
...
backupDir = 'backup_b_car_simulation_metabolites_model_detailed_D025.mat';                                  % direction and name of backup file
